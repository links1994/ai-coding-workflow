...
实现 F-002 人设风格管理的完整功能，包含：
- **应用层**（mall-agent-employee-service）：人设风格配置 CRUD 业务逻辑、Inner API
- **门面层**（mall-admin）：管理后台人设风格接口，通过 Feign 调用应用层
...
│  - StyleConfigApplicationService         │
│  - StyleConfigQueryService / ManageService│
│  - AimAgentStyleConfigService / Mapper   │
└──────────────────────────────────────────┘
```
